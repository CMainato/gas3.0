...

{
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Establecer entrega", style: TextStyle(fontSize: 18.0, fontFamily: "Brand-Blod"),),
                      ),
                    ],
                  ),
  ...
  void findPlace(String placeName) async
  {
    ...
    {
      String autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:ec";

      var res = await ResquestAssistant.getRequest(autoCompleteUrl);
...
class PredictionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      padding: EdgeInsets.all(0.0),
      onPressed: (){
        getPlaceAddresDetails(placePredictions.place_id.toString(), context);
      },
      child: Container(
          child:Column(
          children: [
  ...
  void getPlaceAddresDetails(String placeId, context) async
  {
    showDialog(
        context: context,
    ...
    if(res["status"]=="OK")
    {
     ...
     print("ESTE ES EL LUGAR DE ENTREGA");
